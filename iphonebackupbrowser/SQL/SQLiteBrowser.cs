...
using iphonebackupbrowser.SQL;

namespace iphonebackupbrowser
{
    public partial class DatabaseInspector : Form
    {
        private static string m_DatabaseFilePath;
        private Dictionary<string, Table> m_Tables = new Dictionary<string, Table>();

        public DatabaseInspector(string databaseFilePath)
        {
            InitializeComponent();

            databaseTableExtraction(databaseFilePath);
        }
